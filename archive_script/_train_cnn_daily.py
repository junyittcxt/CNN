...
optparser.add_option("-t", "--threshold", default=0, help="threshold")
opts = optparser.parse_args()[0]

assetindex = int(opts.assetindex)
thresholdindex = int(opts.threshold)
...
print("threshold:", threshold[thresholdindex])
print("=============================")
DATA_PARAMS = dict()
...
DATA_PARAMS["TARGET_THRESHOLD"] = threshold[thresholdindex]
...
MODEL_PARAMS["LEARNING_RATE"] = 0.000002
MODEL_PARAMS["monitor_loss"] = "val_loss"
MODEL_PARAMS["mode_loss"] = "min"
INIT_TIME =  str(int(time.time()))
MODEL_PARAMS["outputmain_folder"] = os.path.join("output", "RS02_RNNSharpe_1_Day_1_Threshold_" + str(threshold[thresholdindex]) + "_60_5")
