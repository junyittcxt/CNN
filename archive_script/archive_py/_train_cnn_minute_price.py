...
print("=============================")
DATA_PARAMS = dict()
DATA_PARAMS["raw_data_file"] = "./DATA/PRICE_LIQUIDASSET_30_MIN.csv"
...
DATA_PARAMS["SEQ_LEN"] = 10
DATA_PARAMS["BREAKOUT_WINDOW"] = 90
...
MODEL_PARAMS["outputmain_folder"] = os.path.join("/media/workstation/9EB4ABE9B4ABC1DF/DL_Output", "R3M30q01_RNN_3_Min_30_Breakout_Long_90_10_1")
