...
def full_train_minute_price(DATA_PARAMS, MODEL_PARAMS):
    ...
    # DATA_PARAMS["raw_data_file_name"] = "PRICE_LIQUIDASSET_60_MIN.csv"
    #
    ...
    # MODEL_PARAMS["ASSET_FOLDER_NAME"] = ASSET_FOLDER_NAME
    #
    # MODEL_PARAMS["training_code"] = "R2M60p01"
    #
    # MODEL_PARAMS["outputmain_folder"] = os.path.join("output", MODEL_PARAMS["training_code"], "ASSETS_MODELS")
    # MODEL_PARAMS["collect_signal_folder"] = os.path.join("output", MODEL_PARAMS["training_code"], "SIGNAL")
    # MODEL_PARAMS["collect_bestmodel_folder"] = os.path.join("output", MODEL_PARAMS["training_code"], "BESTMODEL")
